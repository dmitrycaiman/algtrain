...
func Test_lc_0027_remove_element(t *testing.T) {
	cases := []struct {
		...
		{input: []int{2, 5, 4, 3, 3, 4, 6, 1, 9, 3}, output: []int{2, 5, 4, 4, 6, 1, 9, 1, 9, 3}, val: 3, res: 7},
		{input: []int{2, 5, 4, 3, 3, 4, 6, 1, 9, 3}, output: []int{2, 5, 3, 3, 6, 1, 9, 3, 9, 3}, val: 4, res: 8},
		{input: []int{2, 5, 4, 3, 3, 4, 6, 1, 9, 3}, output: []int{5, 4, 3, 3, 4, 6, 1, 9, 3, 3}, val: 2, res: 9},
		{input: []int{2, 5, 4, 3, 3, 4, 6, 1, 9, 3}, output: []int{2, 5, 4, 3, 3, 4, 6, 1, 3, 3}, val: 9, res: 9},
		{input: []int{2, 5, 4, 3, 3, 4, 6, 1, 9, 3}, output: []int{2, 5, 4, 3, 3, 4, 6, 1, 3, 3}, val: 9, res: 9},
		{input: []int{2, 5, 5, 5, 3, 4, 6, 5, 5, 3, 5}, output: []int{2, 3, 4, 6, 3, 4, 6, 5, 5, 3, 5}, val: 5, res: 5},
	}
	for _, v := range cases {
		n := lc_0027_remove_element(v.input, v.val)
		assert.Equal(t, v.res, n)
